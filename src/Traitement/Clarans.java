...
public class Clarans {
    ...
    public static void CLARANS_Algorithme(int k, int numlocal, int maxneighbor,
                                          ArrayList<Instance> all_instances, JFXTextArea textArea, JFXTextField cout,JFXTextField temp){
